...
(() => {
  ...
  // 모바일 주소창 변화 대응(지원 브라우저에서)
  if (window.visualViewport) {
    visualViewport.addEventListener("resize", setHeaderOffset, { passive: true });
  }

  // ✅ (옵션) 헤더 높이가 동적으로 바뀌는 경우까지 완벽하게
  // 예: 공지바 열림/닫힘, 폰트 로딩, 메뉴 상태 변화 등
